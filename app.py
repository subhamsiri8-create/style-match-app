...
def get_pro_color_name(rgb):
    ...
    colors = {
        ...
        "Burnt Orange": (204, 85, 0), "Charcoal Grey": (54, 69, 79), 
        "Silver": (192, 192, 192), "Warm Beige": (245, 245, 220)
    }
...
if uploaded_file:
    ...
    with st.spinner("Analyzing professional color names..."):
        exact_rgb = extract_fabric_dye(img_pil)
